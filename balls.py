...
class balls(sprite.Sprite): #in the parentheses it is indicated that the class inherits from the Sprite class
    ...
    def __init__(self, x, y):
       ...
       self.image = transform.scale(self.image, (15,15)) # resize the image
